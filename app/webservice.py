...
app = FastAPI(
    title='OpenAI Whisper - Automatic Speach to Text',
    description='A Transformer sequence-to-sequence model trained on various speech processing tasks, including multilingual speech recognition, speech translation, spoken language identification, and voice activity detection.',
    version='version',
    contact={
        "url": 'https://192.168.2.41'
    },
...
# Read in environment variable, passed in by Docker - defaults to 'base'
